-- 99% sure y'all skids gon steal this.
...
Log2.Text = "2. Added pvp Scripts, ain't that hot?"
...
Log3.Text = "3. Added a hilarious Crack feature"
...
Ending.Text = "Tryharded on this, more likes makes more updates!"
